...
class JamesHelper:
    ...
    def ensure_user_exists(self, username, password):
        ...
        session = JamesHelper.Session(james_config['host'], james_config[
            'port'], james_config['username'], james_config['password'])
    ...
    class Session:
        ...
        def __init__(self, host, port, username, password):
            ...
            self.write(password + "\n")
            self.read_until("Welcome root. HELP for a list of "
                                   "commands")
